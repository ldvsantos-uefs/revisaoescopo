...
setwd("C:/Users/vidal/OneDrive/Documentos/13 - CLONEGIT/revisaoescopo/2-DADOS/1-ESTATISTICA/1-RSTUDIO/11-CONFORMIDADE_FAIR")
...
p2 <- ggplot(scores_radar, aes(x = dimensao, y = percentual, group = 1)) +
  geom_polygon(fill = "steelblue", alpha = 0.4, color = "steelblue", size = 1.5) +
...
ggsave("plot2_radar_dimensoes.png", p2, width = 8, height = 8, dpi = 300)

# 6.3 Bar plot: Indicadores individuais
p3 <- ggplot(indicadores, aes(x = reorder(indicador, percentual), y = percentual)) +

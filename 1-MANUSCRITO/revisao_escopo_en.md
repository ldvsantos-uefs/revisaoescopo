...
To empirically quantify methodological gaps and substantiate the operational criteria of Digital Terroir, four complementary inferential analyses were conducted. Seeking to analyze the impact of spatial validation on predictive performance, models with geographically independent partitioning (n=70 ) were compared to conventional random partitioning (n=78 ), calculating the percentage degradation in performance between internal validation and external tests. Differences were evaluated using Mann-Whitney U [@Mann1947], with effect size quantified by Cohen's d [@Cohen1988]: small (d=0,2 ), medium (d=0,5 ), or large (d=0,8 ) according to @Sawilowsky2009. Logistic regression [@Hosmer2013] estimated the odds ratio of high-performance (acurácia 85%) as a function of spatial validation, controlling for algorithm and product, following @Kuhn2013. 

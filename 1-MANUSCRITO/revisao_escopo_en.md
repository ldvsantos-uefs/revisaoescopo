...
![](2-FIGURAS/2-EN/abstract.png){width="80%"}
...
The application of ML in GIs, therefore, is not just a technical innovation, but a tool for epistemic sovereignty and environmental justice. It allows local communities to convert their tacit knowledge and management practices into verifiable data, protecting their genetic and cultural resources against misappropriation [@Suh2007]. However, current literature lacks a synthesis connecting these sensing technologies to the urgent demands of environmental monitoring.
